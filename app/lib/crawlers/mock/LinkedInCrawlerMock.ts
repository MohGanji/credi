/**
 * Mock LinkedIn profile crawler for testing
 * Contains the original mock implementation moved from LinkedInCrawler.ts
 */

import { BaseCrawler } from '../BaseCrawler';
import { ProfileData, Post } from '../types';

export class LinkedInCrawlerMock extends BaseCrawler {
